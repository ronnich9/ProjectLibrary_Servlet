...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-10 col-lg-8">
            ...
            <form class="card card-sm" action="${pageContext.request.contextPath}/app/index" method="post">
                ...
                <div class="card-body row no-gutters align-items-center">
                    ...
                    <!--end of col-->
                    <div class="col">
                        <input class="form-control form-control-lg form-control-borderless" name="searchValue"
                               id="searchValue"
                               type="text"
